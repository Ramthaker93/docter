...
public class Product_list_geter {
    String tv1,tv2,tv3,tv4,tv5,tv6,tv7,tv8;

    public Product_list_geter(String a, String b, String c, String d, String e, String f, String g) {
        this.tv1 = a;
        this.tv2 = b;
        this.tv3 = c;
        this.tv4 = d;
    ...
    public String gettv2() { return tv2; }
