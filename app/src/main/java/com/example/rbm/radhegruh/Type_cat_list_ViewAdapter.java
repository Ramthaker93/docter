...
class Type_cat_list_ViewAdapter extends ArrayAdapter<Type_cat_list_geter> {

    //   SessionManager session;
    String name, email;
    ProgressDialog loading;
    //the hero list that will be displayed
    private List<Type_cat_list_geter> heroList;
    ...
    public Type_cat_list_ViewAdapter(List<Type_cat_list_geter> heroList, Context mCtx) {
        super(mCtx, R.layout.type_cat_single_item, heroList);
...
//        email = user.get(SessionManager.KEY_EMAIL);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.type_cat_single_item, null, true);
...
//        final TextView discount = (TextView) convertView.findViewById(R.id.discount);
        ...
        final Type_cat_list_geter hero = heroList.get(position);
...
//        pro_price=hero.gettv6();
                ...
                Intent intent = new Intent(mCtx.getApplicationContext(), Sub_cat_list.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                intent.putExtra("type_cat_id", hero.gettv1());
