...
class Sub_cat_list_ViewAdapter extends ArrayAdapter<Sub_cat_list_geter> {

    //   SessionManager session;
    String name, email;
    ProgressDialog loading;
    //the hero list that will be displayed
    private List<Sub_cat_list_geter> heroList;
    ...
    public Sub_cat_list_ViewAdapter(List<Sub_cat_list_geter> heroList, Context mCtx) {
        super(mCtx, R.layout.sub_cat_single_item, heroList);
...
//        email = user.get(SessionManager.KEY_EMAIL);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.sub_cat_single_item, null, true);
...
//        final TextView discount = (TextView) convertView.findViewById(R.id.discount);
        ...
        final Sub_cat_list_geter hero = heroList.get(position);
...
//        pro_price=hero.gettv6();
                ...
                Intent intent = new Intent(mCtx.getApplicationContext(), Product_grid.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                intent.putExtra("sub_id", hero.gettv1());
...
//        price.setText("Rs " + hero.gettv6());
//        price_old.setText("Rs" + hero.gettv5());
//        discount.setText("Discount Rs" + hero.gettv7() + " %");
        Picasso.with(mCtx).load(hero.gettv5()).resize(260, 180).into(img);
